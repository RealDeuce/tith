#!/usr/bin/env python3
"""Require complete LLVM source coverage for named conformance files."""
...
def main() -> int:
	if len(sys.argv) < 3:
		raise SystemExit("usage: check_source_coverage.py REPORT SOURCE...")
